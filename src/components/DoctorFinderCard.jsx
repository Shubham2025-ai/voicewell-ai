          ...
          <div key={r.id}>
            <div
              ...
              style={{
                ...
                background: expanded === i ? 'rgba(255,255,255,0.12)' : 'rgba(255,255,255,0.06)',
                border: `1px solid ${expanded === i ? 'rgba(255,255,255,0.2)' : 'rgba(255,255,255,0.08)'}`,
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <div style={{
                  ...
                  background: i === 0 ? 'var(--green)' : 'rgba(255,255,255,0.15)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: 10, fontWeight: 700, color: i === 0 ? '#000' : 'rgba(255,255,255,0.7)',
                  fontFamily: 'var(--font-mono)',
                }}>
                  {i + 1}
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.95)', truncate: true }}>
              ...
              {expanded === i && (
                <div style={{ marginTop: 8, paddingTop: 8, borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                  ...
                  {r.phone && (
                    <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)', marginBottom: 5 }}>
                      📞 <a href={`tel:${r.phone}`} style={{ color: 'var(--green)' }}>{r.phone}</a>
                    </div>
                  )}
                  {r.hours && (
                    <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)', marginBottom: 5 }}>
